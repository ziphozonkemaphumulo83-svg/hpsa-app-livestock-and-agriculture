...
function addActivity(msg){
  ...
  if(list.children[0]?.textContent==="No recent actions") list.innerHTML="";
  const li=document.createElement("li");
  li.textContent=msg;
  list.prepend(li);
}

// Example: attach to export button
document.getElementById("exportBtn")?.addEventListener("click", ()=>{
  addActivity("Exported census report");
});

// You can also call addActivity("Applied filter: Dip Tank A");
